...
baneform.savefig("img/krummning.png", bbox_inches='tight')
# plt.ylim(0,0.350)
plt.grid()
# plt.show()
...
plt.ylabel('\u03b2 ($\u00B0$)')
plt.plot(x, beta_deg)
graf_beta.savefig("img/helningsvinkel.png", bbox_inches='tight')
...
plt.ylabel('v ($m/s$)')
plt.plot(x,v)
graf_v.savefig("img/hastighet.png", bbox_inches='tight')
...
plt.plot(x,a_perp)
graf_a_perp.savefig("img/sentripetalakselarasjon.png", bbox_inches='tight')
...
plt.plot(x,acc)
graf_acc.savefig("img/akselerasjon_x.png", bbox_inches='tight')
...
plt.plot(x,N)
normal_force.savefig("img/normalkraft.png", bbox_inches='tight')
...
plt.xlabel('tid ($s$)')
plt.plot(x,v_x)
graf_v_x.savefig("img/hastighet_i_x.png", bbox_inches='tight')
...
plt.xlabel('tid ($s$)')
plt.plot(x,v_x_avg)
graf_v_x_avg.savefig("img/gjennomsnitt_hastighet_i_x.png", bbox_inches='tight')
...
plt.plot(t,x)
graf_x_t.savefig("img/x_av_t.png", bbox_inches='tight')
...
plt.plot(t,y)
graf_y_t.savefig("img/y_av_t.png", bbox_inches='tight')
...
plt.ylabel('Hastighet ($\dfrac{m}{s}$)')
plt.plot(t,v)
graf_v_t.savefig("img/v_av_t.png", bbox_inches='tight')
...
plt.plot(t,acc)
graf_acc_t.savefig("img/a_av_t.png", bbox_inches='tight')
...
relation.savefig("img/f_delt_paa_n.png", bbox_inches='tight')
